...
class AccountVerification extends Component
{
    ...
    public $assessment_roll_selected;
    public $assessment_roll_search = '';
    ...
    public function UpdatedAssessmentRollSearch(){
        $this->searchAssessmentRoll();
    }

    public function searchAssessmentRoll(){
        $this->assessment_roll_array = MaoAssmtRoll::query()
            ->where('assmt_roll_pin','LIKE','%'.$this->assessment_roll_search.'%')
            ->limit(10)->get();
    }
    ...
    public function mount($id)
    {
        ...
        $this->assessment_roll_search = $data->rpt_pin;
        $this->searchAssessmentRoll();
    ...
    public function mergeRecord()
    {
        ...
        $this->assmt_av = (empty($this->assmt_roll_av) || is_null($this->assmt_roll_av)) ? $this->assmt_av : $this->assmt_roll_av;
        $this->assmt_effective = (empty($this->assmt_roll_effective) || is_null($this->assmt_roll_effective)) ? $this->assmt_effective : $this->assmt_roll_effective;
        $this->assmt_td_arp_no_prev = (empty($this->assmt_roll_td_arp_no_prev) || is_null($this->assmt_roll_td_arp_no_prev)) ? $this->assmt_td_arp_no_prev : $this->assmt_roll_td_arp_no_prev;
        $this->assmt_av_prev = (empty($this->assmt_roll_av_prev) || is_null($this->assmt_roll_av_prev)) ? $this->assmt_av_prev : $this->assmt_roll_av_prev;
    ...
    {
        return view('livewire.mto.account-verification',[
            'document' => MtoRptAccount::with('assessed_values', 'payment_records')
