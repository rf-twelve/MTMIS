<div class="grid grid-cols-6 gap-4 mb-4 overflow-y-auto max-h-96">
    ...
    <div class="space-y-1 sm:col-span-3">
        ...
        <x-select wire:model.debounce.500ms="user_id" id="form" class="w-full border">
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="begin_qty" id="begin_qty" type="text" placeholder="Enter value ex. 123"/>
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="begin_serial_fr" id="begin_serial_fr" type="text" placeholder="Enter value ex. 123"/>
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="begin_serial_to" id="begin_serial_to" type="text" placeholder="Enter value ex. 123"/>
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="issued_qty" id="issued_qty" type="text" placeholder="Enter value ex. 123"/>
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="issued_serial_fr" id="issued_serial_fr" type="text" placeholder="Enter value ex. 123"/>
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="issued_serial_to" id="issued_serial_to" type="text" placeholder="Enter value ex. 123"/>
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="end_qty" id="end_qty" type="text" placeholder="Enter value ex. 123"/>
    ...
    <div class="space-y-1 sm:col-span-2">
        ...
        <x-input wire:model.debounce.500ms="end_serial_fr" id="end_serial_fr" type="text" placeholder="Enter value ex. 123"/>
        @error('end_serial_fr')<x-comment class="text-red-500">*{{ $message }}</x-comment>@enderror
    </div>
    <div class="space-y-1 sm:col-span-2">
        <label for="end_serial_to" class="text-sm">Ending Serial To :</label>
        <x-input wire:model.debounce.500ms="end_serial_to" id="end_serial_to" type="text" placeholder="Enter value ex. 123"/>
