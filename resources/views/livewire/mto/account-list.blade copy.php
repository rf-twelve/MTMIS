            ...
            <div class="px-2 pt-2 sm:px-4 lg:px-4">
                ...
                <div class="flex flex-col mt-2">
                    <div class="min-w-full overflow-hidden overflow-x-scroll align-middle shadow sm:rounded-lg">
                        <x-table>
                            <x-slot name="head">
                                <x-table.head class="px-2 py-1 text-white bg-blue-600">
                                    <x-checkbox wire:model="selectPage" />
                                </x-table.head>
                                <x-table.head class="px-2 py-1 text-white bg-blue-600" sortable wire:click="sortBy('rpt_pin')"
                                    :direction="$sortField === 'rpt_pin' ? $sortDirection : null">PIN
                                </x-table.head>
                                <x-table.head class="px-2 py-1 text-white bg-blue-600" sortable wire:click="sortBy('ro_name')"
                                    :direction="$sortField === 'ro_name' ? $sortDirection : null">Owner's Name
                                </x-table.head>
                                <x-table.head class="w-10 px-2 py-1 text-white bg-blue-600">Kind</x-table.head>
                                <x-table.head class="px-2 py-1 text-white bg-blue-600">Class</x-table.head>
                                <x-table.head class="px-2 py-1 text-white bg-blue-600">Last Payment Date</x-table.head>
                                <x-table.head class="px-2 py-1 text-white bg-blue-600">O.R. No.</x-table.head>
                                <x-table.head class="px-2 py-1 text-white bg-blue-600">Covered</x-table.head>
                                <x-table.head class="w-10 px-6 py-1 text-white bg-blue-600"><span class="sr-only">Edit</span></x-table.head>
                            </x-slot>
