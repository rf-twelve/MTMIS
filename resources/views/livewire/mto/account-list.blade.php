                        ...
                        <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $item->id }}" class="text-gray-600">
                            ...
                            <x-table.cell class="max-w-2xl">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    {{-- VERIFICATION --}}
                                    @if ($item->is_verified != 1)
                                        <a href="{{ route('account-verification',['user_id'=>Auth::user()->id,'id'=>$item->id]) }}" class="px-2 py-2 text-sm font-medium text-center text-gray-700 bg-white border border-gray-300 shadow-sm rounded-xl">
