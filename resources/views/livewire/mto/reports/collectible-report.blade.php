                            ...
                            <div class="sm:items-baseline sm:justify-between">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="mt-2 text-center">
                                        <h3>SUMMARY OF REAL PROPERTY TAX COLLECTIBLE PER BARANGAY</h3>
                                    </div>
                                              ...
                                              <table class="min-w-full divide-y divide-gray-300">
                                                <thead class="bg-gray-50">
                                                    <tr class="text-center divide-x divide-gray-200">
                                                        ...
                                                        <th style="width:15%">NEW ASSESSED VALUE</th>
                                                        <th style="width:15%">OLD ASSESSED VALUE</th>
                                                        <th style="width:15%">OLD AV 1%</th>
                                                        <th style="width:15%">NEW AV 70%</th>
