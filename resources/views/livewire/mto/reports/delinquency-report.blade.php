        ...
        <x-header.navbar>
            <nav class="flex" aria-label="Breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{ route('mto-reports',['user_id'=>Auth::user()->id]) }}" class="ml-4 text-sm font-medium hover:text-blue-100" aria-current="page">Reports</a>
                    </div>
                </li>
                ...
                <li>
                    <div class="flex items-center">
                    <x-icon.chevron-right class="flex-shrink-0 w-5 h-5"/>
                    <a href="#" class="ml-4 text-sm font-medium hover:text-blue-100" aria-current="page">Collectibles</a>
                    </div>
                </li>
                </ol>
            </nav>
                    ...
                    <div class="relative flex flex-col h-full bg-gray-100 border-r border-gray-200 w-96">
                        <div class="flex-shrink-0">
                            <div class="flex justify-between px-6 py-2 text-sm font-medium text-gray-700 bg-blue-300 border-t border-b border-gray-200">
                                <div class="flex">
                                    ...
                                    <span class="pl-2">COLLECTIBLES DETAILS</span>
                        ...
                        <nav class="flex-1 min-h-0 overflow-y-auto">
                            <section aria-labelledby="timeline-title" class="p-4 lg:col-start-3 lg:col-span-1">
                                ...
                                <div class="space-y-1 sm:col-span-2">
                                    <label for="query_array.signatory" class="text-sm">Signatory :</label>
                                    <x-input wire:model.lazy="query_array.signatory" id="query_array.signatory" type="text" placeholder="Enter designation"/>
                                    @error('query_array.signatory')<x-comment class="text-red-500">*{{ $message }}</x-comment>@enderror
                                </div>
                                <div class="space-y-1 sm:col-span-2">
                            ...
                            <div class="sm:items-baseline sm:justify-between">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="mt-2 text-center">
                                        <h3>SUMMARY OF REAL PROPERTY TAX DELINQUENCIES PER BARANGAY</h3>
                                    </div>
                                              ...
                                              <table class="min-w-full divide-y divide-gray-300">
                                                <thead class="bg-gray-50">
                                                    <tr class="text-center divide-x divide-gray-200">
                                                        ...
                                                        <th style="width:15%">Sum of Assessed Value</th>
                                                        <th style="width:15%">Sum of Basic</th>
                                                        <th style="width:15%">Sum of Sef</th>
                                                        <th style="width:15%">Sum of Penalty</th>
                                                        <th style="width:15%">Sum of Total Delinquency</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    @forelse ($assessed_values as $item)
                                                    <tr>
                                                        <td class="p-1 text-left ">{{ 1. }}</td>
