            ...
            <div class="flex items-center  ">
                ...
                <div class="ml-auto flex items-center">
                    ...
                    <button type="button" x-data="" @click="$dispatch('open-command-palette')"
                        class="-my-1 mr-3 sm:mx-2.5 w-8 h-8 rounded-lg flex items-center justify-center">
                        ...
                        <div x-show="open"
                            ...
                            <div class="py-1.5 px-3.5">
                                <a href="/components"
                                    ...
                                    <svg aria-hidden="true" width="20" height="20" fill="none" stroke="currentColor"
                                ...
                                <a href="/documentation"
                                    ...
                                    <svg aria-hidden="true" width="20" height="20" fill="none" stroke="currentColor"
                                        ...
                                        class="flex-none mr-3 text-gray-400 group-hover:text-teal-600">
                                        <path
                                            d="M5.75 17.25h8.5a2 2 0 002-2V7L12 2.75H5.75a2 2 0 00-2 2v10.5a2 2 0 002 2z">
                                        </path>
                            ...
                            <div class="py-1.5 px-3.5">
                                <a href="/documentation#figma-assets"
                                    class="group flex items-center py-1.5 hover:text-teal-600">
                                    <svg aria-hidden="true" width="20" height="20" fill="none"
                                        class="flex-none mr-3 text-gray-400 group-hover:text-teal-600">
                                        <path
                                            d="M6 13.25a3.25 3.25 0 01-1.1-6.31c.473-.17.865-.562.996-1.047a4.252 4.252 0 018.209 0c.13.485.522.878.995 1.048A3.251 3.251 0 0114 13.25M10 11.75v5.5M7.75 14.75l2.25 2.5 2.25-2.5"
                            ...
                            <div class="py-1.5 px-3.5">
                                <a href="/upgrade-team" class="group flex items-center py-1.5 hover:text-teal-600">
                                    <svg aria-hidden="true" width="20" height="20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="flex-none mr-3 text-gray-400 group-hover:text-teal-600">
                                        <rect x="4.75" y="6.75" width="4.5" height="4.5" rx="2.25" stroke="#9CA3AF"
                                            stroke-width="1.5"></rect>
                                        <rect x="10.75" y="2.75" width="4.5" height="4.5" rx="2.25" stroke="#9CA3AF"
                                            stroke-width="1.5"></rect>
                                        <path
                            ...
                            <div class="py-1.5 px-3.5">
                                <a href="/account-settings" class="group flex items-center py-1.5 hover:text-teal-600">
                                    <svg aria-hidden="true" width="20" height="20" fill="none" stroke="currentColor"
                                        stroke-width="1.5"
                                        class="flex-none mr-3 text-gray-400 group-hover:text-teal-600">
                                ...
                                <form method="POST" action="https://tailwindui.com/logout">
                                    <input type="hidden" name="_token" value="CONSTANT_TOKEN"> <button type="submit"
...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <footer
        class="w-full max-w-container mx-auto border-t py-10 text-center text-sm text-gray-500 sm:flex sm:items-center sm:justify-center">
